                    ...
                    <table class="table table-bordered mb-2">
                        ...
                        <tbody>
                            ...
                            <tr id="row_{{$writer->id}}">
                                ...
                                <td class="text-center">
                                    <a href="{{route('publisher.writers.books',$writer->id)}}" class="btn btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="{{trans('common.books')}}">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50" id="full-container">
                    ...
                    {{Form::open(['url'=>route('publisher.writers.store'), 'files'=>'true', 'id'=>'createwriterForm', 'class'=>'row gy-1 pt-75'])}}
        ...
        <div class="modal-dialog modal-md modal-dialog-centered modal-edit-user">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    {{Form::open(['files'=>'true','url'=>route('publisher.writers.store.excel'), 'id'=>'uploadWritersExcelForm', 'class'=>'row gy-1 pt-75'])}}
                        <div class="col-12 col-md-12">
