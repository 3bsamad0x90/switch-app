<li class="nav-item dropdown dropdown-notification me-25">
    ...
    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
        ...
        <li class="scrollable-container media-list">
            ...
            @if(count($MyNotifications) > 0)
                @foreach($MyNotifications as $notification)
                    <a class="d-flex" href="{{route('publisher.notification.details',['id'=>$notification->id])}}">
        ...
        <li class="dropdown-menu-footer">
            <a class="btn btn-primary w-100" href="{{route('publisher.notifications.readAll')}}">{{trans('common.Read all notifications')}}</a>
        </li>
    </ul>
</li>
