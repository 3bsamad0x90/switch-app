...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow container-xxl">
        <div class="navbar-container d-flex content">
            <ul class="nav navbar-nav align-items-center ms-auto">
                @include('PublisherPanel.layouts.topbar.lang')
                ...
                @include('PublisherPanel.layouts.topbar.notifications')
                @include('PublisherPanel.layouts.topbar.profile')
            </ul>
        </div>
    </nav>
    <!-- END: Header-->

    @include('PublisherPanel.layouts.AdminMenu')
        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="content-header row">
                <div class="content-header-left col-md-8 col-12 mb-2">
                    @include('PublisherPanel.layouts.common.breadcrumbs')
                </div>
    ...
    @yield('scripts')
    @include('PublisherPanel.layouts.common.deleteConfirm')
