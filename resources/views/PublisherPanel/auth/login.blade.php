                            ...
                            <div class="card-body">
                                ...
                                <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        {{Form::email('email','',['class'=>'form-control','id'=>'login-email','placeholder'=>'john@example.com','aria-describedby'=>'login-email','autofocus'])}}
                                        @error('email')
                                ...
                                <p class="text-center mt-2">
                                    <span>{{trans('common.DoNotHavePublisherAccount')}}</span>
                                    <a href="{{ route('publisher.register') }}">
                                        <span>{{trans('common.CreateAccountNow')}}</span>
                                    </a>
                                </p>
