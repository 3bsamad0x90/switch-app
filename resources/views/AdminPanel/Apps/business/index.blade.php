                        ...
                        <tbody class="text-center">
                            ...
                            <tr id="row_{{ $app->id }}">
                                ...
                                <td>
                                    ...
                                    <?php $delete = route('admin.business.delete',['id'=>$app->id]); ?>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
                            <div class="modal-content">
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    ...
                                    {{Form::open(['url'=>route('admin.business.update',['id'=>$app->id]), 'id'=>'editappForm', 'class'=>'row gy-1 pt-75','files'=>'true'])}}
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    {{Form::open(['url'=>route('admin.business.store'), 'id'=>'createappForm', 'class'=>'row gy-1 pt-75', 'files'=>'true'])}}
                        <div class="col-12 col-md-6">
                            <label class="form-label" for="appName_ar">إسم التطبيق بالعربية</label>
