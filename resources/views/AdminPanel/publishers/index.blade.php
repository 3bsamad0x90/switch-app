                        ...
                        <tbody>
                            ...
                            <tr id="row_{{$user->id}}">
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{route('admin.publisherUsers.edit',['id'=>$user->id])}}" class="btn btn-icon btn-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="{{trans('common.edit')}}">
                                        <i data-feather='edit'></i>
                                    </a>
                                    <?php $delete = route('admin.publisherUsers.delete',['id'=>$user->id]); ?>
...
@section('page_buttons')
    <a href="{{route('admin.publisherUsers.create')}}" class="btn btn-primary">
