                        ...
                        <tbody>
                            ...
                            <tr id="row_{{$faq->id}}">
                                ...
                                <td class="text-center">
                                    ...
                                    <?php $delete = route('admin.publishersfaqs.delete',['id'=>$faq->id]); ?>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
                            <div class="modal-content">
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    ...
                                    {{Form::open(['url'=>route('admin.publishersfaqs.update',['id'=>$faq->id]), 'id'=>'editfaqForm', 'class'=>'row gy-1 pt-75'])}}
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    {{Form::open(['url'=>route('admin.publishersfaqs.store'), 'id'=>'createfaqForm', 'class'=>'row gy-1 pt-75'])}}
                        <div class="col-12 col-md-2">
                            <label class="form-label" for="ranking">{{trans('common.ranking')}}</label>
