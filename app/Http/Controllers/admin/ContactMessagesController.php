...
class ContactMessagesController extends Controller
{
    ...
    {
        $messages = ContactMessages::where('user_type',null)->orderBy('id','desc')->paginate(25);
    ...
    {
        $messages = ContactMessages::where('user_type','publisher')->orderBy('id','desc')->paginate(25);
        return view('AdminPanel.contactMessages.index',[
            ...
            'breadcrumbs' => [
                [
                    'url' => '',
                    'text' => trans('common.publishersContactMessages')
                ]
            ]
        ]);
    }
